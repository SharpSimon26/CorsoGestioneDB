...
/// vengono scartati
/// </summary>
public class RoundingAdjustmentRule : IReconstructionRule
{
    private readonly ILogger<RoundingAdjustmentRule> _logger;

    public RoundingAdjustmentRule(ILogger<RoundingAdjustmentRule> logger)
    {
        _logger = logger;
    }
